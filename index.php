...
<link href="img/apple-touch-icon-72x72.png" rel="apple-touch-icon"
	sizes="72x72">
<link href="img/apple-touch-icon-76x76.png" rel="apple-touch-icon"
	sizes="76x76">
				...
				<div class="container">
					<div class="row mb-small">
						<div class="col-sm-12 text-center">
							...
							<h2>Last week more than 100 companies signed up to help them in
								their projects.</h2>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6 mb-small">
							<img alt="" class="img-responsive" src="img/template-mac.png">
						</div>
						<div class="col-sm-6 text-center-xs">
							<p class="text-uppercase">
								Business. Corporate. Agency.<br> Portfolio. Blog. E-commerce.<br>
								We have covered everything.
							</p>
							<p>
								See our current packages comparison<br> to choose the right one
								for you.
							</p>
							<p>
								<a class="scroll-to btn btn-template-transparent-black"
									href="#packages">See packages</a>
							</p>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						...
						<p class="mb-small">
							We have prepared literally <strong>everything you would possibly
								need building corporate, e-commerce or portfolio website</strong>.
							If you still miss something, let us know and we will try to
							include it in theme's future updates.
						</p>
						<p>
							<a class="btn btn-template-main" href="#">Read more</a>
						</p>
					</div>
		...
		<section class="bar no-mb color-white padding-big text-center-sm">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						<h2 class="text-uppercase">Clean, valid and documented code &amp;
							support</h2>
						<p class="lead mb-small">We made our best to help you</p>
						<p class="mb-small">Everything in this template is properly named
							and categorized. In case you don't find in the documentation
							answer to your question, our support is here to help!</p>
						<p>
							<a class="btn btn-template-transparent-primary" href="#">Read
								more</a>
						</p>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						...
						<p class="mb-small">
							We have made this template with focus on future client
							customization. You get <strong>40+ prepared HTML templates</strong>,
							many <strong>reusable components</strong> and <strong>LESS files</strong>
							for even easier template customization.
						</p>
						<p>
							<a class="btn btn-template-main" href="#">Read more</a>
						</p>
						...
						<div class="row packages">
							<div class="col-md-3">
								<div class="package">
									...
									<a class="btn btn-template-main" href="#">Sign Up</a>
								</div>
							</div>
							<!-- / END FIRST PACKAGE -->
							<div class="col-md-3">
