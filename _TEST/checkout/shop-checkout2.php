            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 clearfix" id="checkout">
                        ...
                        <div class="box">
                            <form method="post" action="shop-checkout3.php">
                                ...
                                <div class="box-footer">
                                    <div class="pull-left">
                                        <a href="shop-checkout1.php" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Addresses</a>
                                    </div>
