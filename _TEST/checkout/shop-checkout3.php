                        ...
                        <div class="box">
                            <form method="post" action="shop-checkout4.php">
                                <ul class="nav nav-pills nav-justified">
                                    ...
                                    <li class="disabled"><a href="shop-checkout4.php"><i class="fa fa-eye"></i><br>Order Review</a>
                                    </li>
                                </ul>
                                ...
                                <div class="box-footer">
                                    <div class="pull-left">
                                        <a href="shop-checkout2.php" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Shipping method</a>
                                    </div>
