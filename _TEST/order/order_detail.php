                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="<?php echo $app_path;?>account/customer-orders.php">My orders</a>
                            </li>
                            <li>Order # 1735</li>
                        </ul>
                    </div>
            ...
            <div class="container">
			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-9 clearfix" id="customer-order">
                        ...
                        <p class="lead text-muted">If you have any questions, please feel free to <a href="<?php echo $app_path;?>contact.php">contact us</a>, our customer service center is working for you 24/7.</p>
